    ...
    public class GruposAdminController : Controller
    {
        ...
        public async Task<ActionResult> Editar(string id)
        {
            ...
            var model = new GrupoViewModel()
            {
                ...
                Descripcion = applicationgroup.Description
            };
        ...
        public async Task<ActionResult> Editar(
            [Bind(Include = "Id,Name,Description")] GrupoViewModel model, params string[] selectedRoles)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                group.Description = model.Descripcion;
